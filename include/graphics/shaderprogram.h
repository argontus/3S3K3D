...
#ifndef GRAPHICS_SHADERPROGRAM_H_INCLUDED
#define GRAPHICS_SHADERPROGRAM_H_INCLUDED
...
public:
     ...
     * current vertex shader is unregistered. This shader program must be
     * linked before any changes take effect.
     *
    ...
    /**
     * Gets the registered vertex shader. If this shader program does not have
     * a registered vertex shader, the return value is a null pointer.
     *
    ...
    /**
     * Gets a boolean value indicating whether or not this shader program has a
     * registered vertex shader. The return value is equivalent to
     * <code>vertexShader() != 0</code>.
     *
     * @return <code>true</code>, if this shader program has a registered
     * vertex shader, <code>false</code> otherwise.
     */
    bool hasVertexShader() const;

    /**
     * Registers a fragment shader. If <code>p</code> is a null pointer, the
     * current fragment shader is unregistered. This shader program must be
     * linked before any changes take effect.
     *
    ...
    /**
     * Gets the registered fragment shader. If this shader program does not
     * have a registered fragment shader, the return value is a null pointer.
     *
     ...
     *
     * @return <code>true</code>, if this shader program has a registered
     * fragment shader, <code>false</code> otherwise.
     */
    ...
    /**
     * Links this shader program. Calling this member function will overwrite
     ...
     * successful. A shader program can be used only after it has been
     * successfully linked.
     *
    ...
    /**
     * Validates this shader program. Calling this member function will
     * overwrite the current info log string.
     *
     ...
     * attempt was successful. If validation is successful, this shader program
     * is guaranteed to execute given the OpenGL state at the time of the
     * validation. Otherwise, this shader program is guaranteed to not execute.
     *
...
#endif // #ifndef GRAPHICS_SHADERPROGRAM_H_INCLUDED
